...
from design_tokens import available_presets, FORCED_STYLE_PRESET, force_style_preset
...
def _canonical_style_preset(value: str, *, source: str) -> str:
    if FORCED_STYLE_PRESET:
        # Every caller resolves a preset name from some source -- design_brief,
        # style contract, CLI. All are overridden while one is forced.
        return force_style_preset(value)
